class AddHoldSoftkeyFunction < ActiveRecord::Migration
  def up
    softkey_function = SoftkeyFunction.find_or_create_by_name('hold')
  ...
  def down
    softkey_function = SoftkeyFunction.find_by_name('hold')
