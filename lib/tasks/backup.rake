namespace :backup do
  ...
  task :restore => :environment do
    ...
    if RestoreJob.where(:state => 'new').any?
      ...
      system "cd #{restore_directory} && tar xf GS5.tar && rm GS5.tar"

      # Restore faxes
      #
      system "cd / && tar xzfP #{restore_directory}/GS5/archives/faxes.tar.gz"

      # Restore voicemails
      #
      # system "cd / && tar xzfP #{restore_directory}/GS5/archives/voicemails.tar.gz"
